package com.rds_project_demo.config;
...
@EnableJpaRepositories(
        basePackages = "com.rds_project_demo.repository", // TODO Repository 패키지 지정
...
public class DBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder.dataSource(dataSource)
                .packages("com.rds_project_demo.Member") // TODO Model 패키지 지정
                .properties(map)
                .build();
    }
